...
<div class="container"  style="margin-top:5%; min-height:500px">
	<h3>MULTIBOARD - 글쓰기 </h3>
		<form action="${pageContext.request.contextPath}/reply.do" method="post"  id="writeForm" enctype="multipart/form-data">
		   <fieldset>
		   <legend>WRITE(CREATE)</legend>
			...
			<input type="hidden" value="${dto.bgroup}" id="bgroup" name="bgroup">		
			<input type="hidden" value="${dto.bstep}" id="bstep" name="bstep">		
			<input type="hidden" value="${dto.bindent}" id="bindent" name="bindent">		
